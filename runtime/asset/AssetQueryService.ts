import type { AssetSection, AttributeQueryMatch, FindAttributesResult, QueryMatch } from "../types";
import { getAssetPath, matches, splitPath, valuesEqual, valuesLooselyEqual } from "./assetUtils";
import { AssetTemplateService } from "./AssetTemplateService";

export class AssetQueryService {
  private readonly getState: () => AssetSection;
  private readonly templateService: AssetTemplateService;

  constructor(getState: () => AssetSection, templateService: AssetTemplateService) {
